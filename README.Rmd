...
The goal of alantestpackage is to make regular expressions more exciting!
...
You can install the development version of alantestpackage from [GitHub](https://github.com/) with:
