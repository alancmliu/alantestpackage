...
The goal of alantestpackage is to make regular expressions more
...
You can install the development version of alantestpackage from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("jennybc/alantestpackage")
```
...
That’s exactly what `alantestpackage::str_split_one()` does.

``` r
library(alantestpackage)
